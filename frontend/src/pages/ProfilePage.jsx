      ...
      <div className="h-full overflow-auto px-4 py-6 lg:px-8">
        <div className="mx-auto max-w-2xl">
          ...
          <div className="glass rounded-2xl p-6 mb-4">
            <h2 className="mb-4 font-display font-semibold text-sm uppercase tracking-wide" style={{ color: "var(--text-muted)" }}>Profile Photo</h2>
            ...
            {showAvatarPicker && (
              <div className="mt-5">
                ...
                <div className="grid grid-cols-6 gap-2">
                  {AVATARS.map((url, i) => (
                    <button key={i} onClick={() => { setForm({ ...form, profilePic: url }); setShowAvatarPicker(false); }}
                ...
                <div className="mt-3">
                  ...
                  <input value={form.profilePic} onChange={e => setForm({ ...form, profilePic: e.target.value })}
          ...
          {/* Personal Info */}
          <div className="glass rounded-2xl p-6 mb-4">
            <h2 className="mb-4 font-display font-semibold text-sm uppercase tracking-wide" style={{ color: "var(--text-muted)" }}>Personal Info</h2>
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea value={form.bio} onChange={e => setForm({ ...form, bio: e.target.value })}
                  placeholder="Tell people about yourself..." rows={3} className="input-field resize-none" maxLength={200} />
          ...
          <div className="glass rounded-2xl p-6 mb-6">
            <h2 className="mb-4 font-display font-semibold text-sm uppercase tracking-wide" style={{ color: "var(--text-muted)" }}>Account</h2>
          ...
          <button onClick={() => saveProfile(form)} disabled={isPending}
